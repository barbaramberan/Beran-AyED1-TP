...
print(
    "Vamos a crear una lista con todos los números que sean múltiplos de 7, pero no de 5, en un rango determinado por vos.\n"
)

a = int(
    input(
        "Ingresá un número entero positivo para definir donde querés que empiece ese rango: "
    )
)
b = int(
    input(
        "Ingresá un número entero positivo para definir donde querés que termine ese rango: "
    )
)
