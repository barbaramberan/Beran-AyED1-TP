...
def _calcular_vuelto(compra: int, pago: int) -> list:
    ...
    resto = resto % 10
    if resto > 0:
        print(f"No es posible devolver los {resto}$ restantes. Te puedo dar un caramelo")
    lista_vuelto = [(5_000, cant_5_000), (1_000, cant_1_000), (500, cant_500), (200, cant_200), (100, cant_100), (50, cant_50), (10, cant_10)]
    return lista_vuelto
...
def main() -> None:
    ...
    lista_billetes = _calcular_vuelto(compra, pago)
