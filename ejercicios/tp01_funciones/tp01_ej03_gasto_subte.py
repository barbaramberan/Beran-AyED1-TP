...
def _calcular_viajes(viajes: int, precio_boleto: int) -> float:
    ...
    combinaciones = [(20, 0), (30, 20), (40, 30), (999, 40)] #Lista de tuplas combinando límites de pasajes con su descuento
...
def main() -> None:
    ...
    precio_boleto = 4_000
    gastos_transporte = _calcular_viajes(viajes, precio_boleto)
    print(f"El total gastado este mes en transporte es de: {gastos_transporte}$")

if __name__ == "__main__":
    assert _calcular_viajes(20, 1_000) == 20_000
    assert _calcular_viajes(30, 1_000) == 28_000
    assert _calcular_viajes(32, 4_000) == 117_600
    main()
